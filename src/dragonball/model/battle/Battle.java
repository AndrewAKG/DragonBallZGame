...
public class Battle implements Serializable{
	...
	public SuperAttack MostSuperAttack(){
		   SuperAttack Most = ((Fighter)(this.getAttacker())).getSuperAttacks().get(0);
		   for (int i = 1; i < ((Fighter)(this.getAttacker())).getSuperAttacks().size(); i++) {
			if(((Fighter)(this.getAttacker())).getSuperAttacks().get(i).getDamage()> Most.getDamage()){
				Most = ((Fighter)(this.getAttacker())).getSuperAttacks().get(i);
			}
		}
		   return Most ;
	   }
	
	   public UltimateAttack MostUltimateAttack(){
		   UltimateAttack Most = ((Fighter)(this.getAttacker())).getUltimateAttacks().get(0);
		   for (int i = 1; i < ((Fighter)(this.getAttacker())).getUltimateAttacks().size(); i++) {
			if(((Fighter)(this.getAttacker())).getUltimateAttacks().get(i).getDamage()> Most.getDamage()){
				Most = ((Fighter)(this.getAttacker())).getUltimateAttacks().get(i);
			}
		}
		   return Most ;
	   }
...
//	   if((Fighter)(this.getAttacker() == null ){
//		   this.attack(new PhysicalAttack());
//			Fighter x = ((Fighter)(this.getAttacker()));
//			Fighter y = ((Fighter)(this.getDefender()));
//			if(x.getKi()==0){
//				this.attack(new PhysicalAttack());
//			}
//			else if(x.getKi() == 1 && ) {
//				this.attack(MostSuperAttack());
//			}
//			else if(x.getKi()== 2){
//				this.attack(new PhysicalAttack());
//			}
//			else if (x.getKi()>=3){
//				this.attack(MostUltimateAttack());
//			}
